  ...
  <div class="wbipt_select_ctn">
    ...
    <div class="wbipt_select_right">
      <el-select v-model="value" :placeholder="setting.describe" v-on:change="updateValue">
        <el-option v-if="setting.model" v-for="(item,i) in options" :key="i" :label="item.label" :value="item.value">
        </el-option>
      </el-select>
...
<script>
  export default {
    props: ["setting", "options", "contents", 'cid'],
    data() {
      return {
        value: "",
