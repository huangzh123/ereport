<template>
  <div id="my-form">
    <div class="top-bar">
      ...
      <div class="menu">
        <a class="zhbtn" @click="showCreateForm"><i class="iconfont icon-add1"></i>新建模板</a>
...
<template slot-scope="scope">
    ...
    <el-dialog  title="新建模板" size="small"  :visible.sync="dialog_form">
        <el-form label-position="left" label-width="80px">
          ...
          <el-form-item label="编码/Key">
            <el-input clearable auto-complete="off" placeholder="唯一标识" v-on:change="verifReportCode(form.reportCode,(r) => {illegalCode = !r})" v-model="form.reportCode"></el-input>
      ...
      <el-dialog  title="编辑模板信息" size="small"  :visible.sync="dialog_form_edit">
        <el-form label-position="left" label-width="80px">
          <el-form-item label="模板名称">
